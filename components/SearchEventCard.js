...
export default function EventCard({ id, name, eventTimestamp, imageURL }) {
  return (
    <div className="group relative clickable-card2 rounded-lg focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-offset-gray-100 focus-within:ring-indigo-500">
      <Link href={`/event/${id}`}>
